...
## Aim:
To perform a heuristic evaluation and UX comparison of three competing food delivery apps — Swiggy, Zomato, and Uber Eats — and propose design improvements for better usability.


## Algorithm:
Select the three apps: Swiggy, Zomato, and Uber Eats.
Identify key user tasks such as placing an order, searching for restaurants, and tracking delivery.
Evaluate each app using Nielsen’s 10 Usability Heuristics.
Record usability issues, severity ratings, and user feedback.
Compare the apps based on performance, navigation, and visual design.
Suggest UI/UX improvements based on findings.
